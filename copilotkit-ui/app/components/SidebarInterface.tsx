...
export default function SidebarInterface() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)]">
      ...
      <div className="flex-1 p-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-y-auto">
      ...
      {/* Sidebar Chat */}
      <div
        className={`bg-white border-l border-gray-200 shadow-2xl transition-all duration-300 flex flex-col ${
          isOpen ? "w-[420px]" : "w-0"
        }`}
      >
        {isOpen && (
          <>
            <div className="p-5 border-b bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                  <MessageCircle className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h2 className="font-semibold text-white">Sidebar Assistant</h2>
                  <p className="text-xs text-blue-100">AI Research Assistant</p>
                </div>
              </div>
              <button
            ...
            <div className="p-4 border-t bg-white">
              <form onSubmit={handleSubmit} className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 disabled:opacity-50 transition-all shadow-sm flex items-center gap-1"
                >
